...
import { ocultarPanel, ocultarTodosLosPaneles } from "../core/panelManager";

const loginForm = document.getElementById("loginForm");
const profileDropdownToggle = document.getElementById("profileDropdown");

// El dropdown "acceso al módulo" usa data-bs-auto-close="false" para que un clic
// en el mapa no lo cierre; lo cerramos manualmente tras ingresar o salir.
const cerrarDropdownPerfil = () => {
  if (profileDropdownToggle) {
    Dropdown.getOrCreateInstance(profileDropdownToggle).hide();
  }
};

// Al abrir el menú de perfil se ocultan los paneles flotantes (mapas base, mini
// mapa, herramientas) para que no queden superpuestos sobre el menú.
if (profileDropdownToggle) {
  profileDropdownToggle.addEventListener("show.bs.dropdown", () =>
